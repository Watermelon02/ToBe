 ...
 */
class DayInfoAdapter(val dateActivity: DateActivity, var days:List<Day>) : FragmentStateAdapter(dateActivity) {
    override fun getItemCount(): Int = days.size

    override fun createFragment(position: Int): Fragment {
        return DayFragment(days[position].date,dateActivity.viewModel)
    }
